...
class DummyClass extends AppRouting
{
    ...
    public function frontendRoutes(RouterInterface $router)
    {
         ...
         * @uses \DummyNamespace\Controllers\Index::array()
         */
        $router->get('array', [
            'uses' => 'Index@array',
            'as' => 'array',
         ...
         * @uses \DummyNamespace\Controllers\Index::file()
         */
        $router->get('file', [
            'uses' => 'Index@file',
            'as' => 'file',
         ...
         * @uses \DummyNamespace\Controllers\Index::download()
         */
        $router->get('download', [
            'uses' => 'Index@download',
            'as' => 'download',
         ...
         * @uses \DummyNamespace\Controllers\Index::error404()
         */
        $router->get('error404', [
            'uses' => 'Index@error404',
            'as' => 'error404',
