 ...
 * @package Dissonance\Develop\Services\Packages
 */
class DissonancePackageCreator extends StaticPackageCreator implements AppPackageInterface, CorePackageInterface
{
    ...
    protected function makePackageFiles()
    {
        if ($this->with_app) {
            ...
            if ($this->parent_app_id) {
                $this->dissonance['app']['parent_app'] = $this->parent_app_id;
            }
            $this->createAssets();
            if ($this->with_app_controllers) {
                $this->dissonance['app']['controllers_namespace'] = '\\' . $this->getBaseNamespace() . '\\Http\\Controllers';
    ...
    protected function createDemoResources()
    {
        ...
        $files = [
            'resources/views/demo/layout.blade.php' => 'resources/views/backend/layout.blade.php',
            'resources/views/backend/index.blade.php' => 'resources/views/backend/index.blade.php',
            'resources/views/backend/backend.blade.php' => 'resources/views/backend/index.blade.php'
        ];
    ...
    {
        $this->dissonance['bootstrappers'] = ['\\' . $this->getBaseNamespace() . '\\Bootstrap\\Bootstrap'];
        $this->createClassesFiles([
    ...
    {
        $this->dissonance['app']['app_class'] = ['\\' . $this->getBaseNamespace() . '\\MyAppContainer'];
        $this->createClassesFiles([
    ...
    {
        $this->dissonance['app']['providers'] = ['\\' . $this->getBaseNamespace() . '\\Providers\\AppProvider'];
        $this->createClassesFiles([
    ...
    {
        $this->dissonance['app']['routing'] = '\\' . $this->getBaseNamespace() . '\\Routing';
        $this->createClassesFiles([
    ...
    {
        $this->dissonance['providers'] = ['\\' . $this->getBaseNamespace() . '\\Providers\\CoreProvider'];
        $this->createClassesFiles([
