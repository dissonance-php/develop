...
class StaticPackageCreator implements StaticPackageInterface
{
    ...
    {
        $this->dissonance['public_path'] = 'assets';
        $files = [
    ...
    {
        $this->dissonance['resources_path'] = 'resources';
        $files = [
    ...
    protected function createComposerFile()
    {
        $this->createFile(
            ...
            \json_encode($this->composer, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_THROW_ON_ERROR)
        );
    }
